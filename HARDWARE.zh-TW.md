...
| 最長不中斷關聯 | **123 小時 23 分**（5 天 3 小時 23 分），2026-08-27 18:03:59 → 2026-09-01 21:27:00，結束於一次只有本站看得到的 beacon loss，12 秒後恢復。前一個紀錄是 28 小時 34 分 | **7 天 17 小時且仍在持續**（2026-09-03）——整份 journal 只有一次 `CTRL-EVENT-CONNECTED`，完全沒有 `DISCONNECTED`，跑在 6.12.96 上由 DKMS 安裝的模組。這是兩片板子產生過最長的關聯 |
